...
def get_prediction(
    ...
    try:
       pred_depth, confidence, output_dict = model.inference(data)
        ...
        pred_depth, confidence, output_dict = model.modules.inference(data)
...
def do_scalecano_test_with_custom_data(
    ...
    #for i, an in enumerate(test_data):
        ...
        if intrinsic is None:
            ...
            #intrinsic = [3100.0, 3100.0, rgb_origin.shape[1]/2, rgb_origin.shape[0]/2] pixel 6a
            # intrinsic = [4300.0, 4300.0, rgb_origin.shape[1]/2, rgb_origin.shape[0]/2] pixel
